...
This version created by [Alejandro Liu](https://github.com/alejandroliu)
...
- Build script [`muninlite.mk` for floppyfw devkit](http://pong.no/floppyfw/muninlite/)
- post ini [script (post-muninlite.ini) for floppyfw](http://pong.no/floppyfw/muninlite/)
